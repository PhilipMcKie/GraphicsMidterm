...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	private void makePoly(GL2 gl2, Polyhedron P)
	{
		gl2.glPushMatrix();
		int i;
		int j;
		...
		{
			//gl2.glColor3dv(P.faceColors[i], 0);
			gl2.glBegin(GL2.GL_TRIANGLE_FAN);
			for (j = 0; j < P.faces[i].length; j++)
			{
				int vertexNum = P.faces[i][j];
				double[] vertexCoords = P.vertices[vertexNum];
				gl2.glNormal3d(-P.normals[i][0], -P.normals[i][1], -P.normals[i][2]);
	...
	private void setMaterial(GL2 gl2, int num)
	{
		gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT, materials[num], 0 );
		gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_DIFFUSE, materials[num], 4 );
		gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, materials[num], 8 );
		gl2.glMaterialf( GL2.GL_FRONT_AND_BACK, GL2.GL_SHININESS, materials[num][12] );
	}
	...
	public void display(GLAutoDrawable drawable) {    
		...
		glut.glutSolidTorus(1,1,128,128);
		gl2.glPopMatrix();
		
		setMaterial(gl2, 2);
		gl2.glPushMatrix();
		gl2.glTranslated(10,0.5,10);
		...
		setMaterial(gl2, 3);
		gl2.glPushMatrix();
		gl2.glTranslated(5,1,0);
		gl2.glScaled(2, 2, 2);
		makePoly(gl2, Polyhedron.socerBall);
		gl2.glPopMatrix();
		
		setMaterial(gl2, 14);
		gl2.glPushMatrix();
		gl2.glTranslated(-10,.8,-10);
		gl2.glScaled(2, 2, 2);
		makePoly(gl2, Polyhedron.dodecahedron);
		gl2.glPopMatrix();
		...
		gl2.glTranslated(10,.8,-10);
		gl2.glScaled(2, 2, 2);
		makePoly(gl2, Polyhedron.truncatedIcosahedron);
		gl2.glPopMatrix();
		...
		//gl2.glScaled(2, 2, 2);
		makePoly(gl2, Polyhedron.truncatedRhombicDodecahedron);
		gl2.glPopMatrix();
	...
	public void init(GLAutoDrawable drawable) {
		...
		float[] blue1 = { 0.1f, 0.1f, 0.3f, 1 };
		float[] blue2 = { 0.0f, 0, 0.3f, 1 };
		float[] blue3 = { 0.0f, 0, 0.1f, 1 };
		...
		float[] position1 = { 5,2,0,0 };
		gl2.glLightfv(GL2.GL_LIGHT1, GL2.GL_POSITION, position1, 0);
		float[] red1 = { 0.3f, 0.1f, 0.1f, 1 };
		float[] red2 = { 0.3f, 0, 0, 1 };
		float[] red3 = { 0.1f, 0, 0, 1 };
		gl2.glLightfv( GL2.GL_LIGHT2, GL2.GL_DIFFUSE, red1, 0 );
		gl2.glLightfv( GL2.GL_LIGHT2, GL2.GL_SPECULAR, red2,0 );
		gl2.glLightfv( GL2.GL_LIGHT2, GL2.GL_AMBIENT, red3,0 );
		float[] position2 = { -5,2,0,0 };
		gl2.glLightfv(GL2.GL_LIGHT2, GL2.GL_POSITION, position2, 0);
		float[] green1 = { 0.1f, 0.3f, 0.1f, 1 };
		float[] green2 = { 0, 0.3f, 0, 1 };
		float[] green3 = { 0, 0.1f, 0, 1 };
		gl2.glLightfv( GL2.GL_LIGHT3, GL2.GL_DIFFUSE, green1, 0 );
		gl2.glLightfv( GL2.GL_LIGHT3, GL2.GL_SPECULAR, green2,0 );
		gl2.glLightfv( GL2.GL_LIGHT3, GL2.GL_AMBIENT, green3,0 );
		float[] position3 = { 0,0,5,1 };
		gl2.glLightfv(GL2.GL_LIGHT3, GL2.GL_POSITION, position3, 0);
